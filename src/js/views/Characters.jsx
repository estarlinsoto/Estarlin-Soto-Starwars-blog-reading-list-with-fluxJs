...
export const Characters = () => {
  ...
  return (
    <div className="container">
      ...
      <h3 className="text-center">Page {page}/9</h3>
      <div className=" row ">

          <div className={page === 1 ? "hide" : store.allData.length === 0 ? "hide" :"col text-start"} onClick={() => setPage(page - 1)} >
            <button type="button" class="btn btn-warning" onClick={() => actions.prevPageFunc(page - 1)} >Prev</button>
          </div>
  
            <div className={page === 9 ? "hide" : store.allData.length === 0 ? "hide" : " col text-end"} onClick={() => setPage(page + 1)} >
